...
describe('Pruebas en AuthThunks',()=>{
    ...
    test('startGoogleSignIn debe de llamar checkingCredentials y logout - Error', async()=>{
     ...
     test('startLoginWithEmailPaaword debe de llamar checkingCredentials y Login - Exito ',async()=>{
        const loginData = {ok:true, ...demoUser};
     ...
     test('startLogout debe de llamr logoutFirebase, clearNotes y logout', async()=>{
